...
for season in notary_pubkeys:
    ...
    for notary in notary_pubkeys[season]:
        ...
        notary_id += 1
    # remove dulicate addresses in list
    season_address_list = list(set(season_addresses[season]))
    season_addresses.update({season:season_address_list})

# Need to fill this in correctly later...
seasons_info = {
    "Season_1": {
            "start_block":1,
            "end_block":1,
