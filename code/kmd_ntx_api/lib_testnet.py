...
def get_api_testnet(request):
    ...
    for chain in testnet_chains:
        ...
        for notary in testnet_stats_dict:
            ...
            try:
                last_chain_ntx = last_ntx[notary][chain]["time_since"]
                last_chain_ntx_time = last_ntx[notary][chain]["block_time"]
